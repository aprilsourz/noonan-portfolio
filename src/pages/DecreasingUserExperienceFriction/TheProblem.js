    ...
    <ContentContainer style={{ maxWidth: "1020px" }}>
      <TextContainer>
        ...
        <BodyTextWithMargin>
          ...
          users. But the more users using the product, the more signals we
          started to receive that users were experiencing unintuitive behavior
          and missing functionality in the campaign editing workflow.
        </BodyTextWithMargin>
        <BodyTextWithMargin>
          At the time, there was no easy way for users to make changes to a
          campaign while there were recipients scheduled to receive touches. If
          a user needed to change the content of an email or change recipient
