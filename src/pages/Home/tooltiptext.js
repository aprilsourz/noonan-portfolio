...
<strong style="font-weight: 700">
  <i style="font-style: italic">Summer days </i>
</strong>
<br />
<br />
...
"popsicles" that Mom would hand out on a hot days, the
ones that make your tongue red or blue or purple, the ones
that we'd always eat about three at a time.
</span>`

const sewingContent = `
<span>
<strong style="font-weight: 700">
  <i style="font-style: italic">Like mother like daughter </i>
</strong>
<br />
<br />
<strong style="font-weight: 700">Fun Fact: </strong>
...
const moonContent = `
  <span>
  <strong style="font-weight: 700">
    <i style="font-style: italic">Moongirl and rainbabies</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
  ...
  reason, I always associate the moon with that book and the
  story of the rainbabies.
  </span>
`
...
const wandContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">A little bit of magic</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
  ...
  the star. I would dress up and use it to accompany me in all
  my delightful imaginings.
  </span>
`

const turntableContent = `
  <strong style="font-weight: 700">
  <i style="font-style: italic">Spinning</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>I always dreamed of owning a record
  player and being that girl with all the records. While I
  didn't quite make that happen - I did end up meeting the boy
  with all the records. And now by way of marriage, I have
  access to TWO record players and a huge collection of records!
  </span>
`
...
const cloudsContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">I love clouds</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
...
const polaroidContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Tangible memories</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
  ...
  was one of our favorite memories—seeing the wedding from
  everyone else's point of view and being able to hold the
  moment in our hands.
  </span>
`
...
const rainbowContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Rainbow</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
...
const mountainsContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">mountains</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
...
const doughnutContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Doughnut or donut?</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact 1: </strong>
  I love the concept of donuts, but I don't like eating them!
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact 2: </strong>I once threw a donut party and had
  all my friends over to choose the best donuts from all over
  the city —and I didn’t even eat any!
  </span>
`

const unicornContent = `
<span>
<strong style="font-weight: 700">Fun Fact: </strong>I LOVE unicorns. Have you seen the
...
const pizzaContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Pizza, pizza, pizza!</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>I LOVE pizza. LOVE IT. One time, I
  went to this place in Brooklyn, NY called Best Pizza — and
  literally, it was the best pizza I’ve ever had in my entire
  life. I think about that pizza a lot.
  </span>
`
...
const pianoContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Piano time</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>I started playing the piano when I
...
const treesContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Treehouse dreams</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
...
const mugContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Mug life</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>I collect mugs! I especially love
...
const mailContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Snail mail trail</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
...
const bostonContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Welcome to Beantown</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact 1: </strong>
  ...
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact 2: </strong>
  In 2014 me and this one guy started working at the same start
  up. And in 2017, we got married!
  </span>
`
...
const starsContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">stars</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
...
const snowboardContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Powder fiend</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact 1: </strong>
  ...
  <br />
  <strong style="font-weight: 700">Fun Fact 2: </strong>
  My first job was as a snowboard instructor at our local
  resort.
  </span>
`
...
const toastContent = `
  <span>
  <strong style="font-weight: 700">
  <i style="font-style: italic">Lil' Toasty</i>
  </strong>
  <br />
  <br />
  <strong style="font-weight: 700">Fun Fact: </strong>
  Toast is my favorite food! Nom!! I have a dream of starting a
  toast shop where people can come and choose a slice of bread
  from all these beautiful homemade loaves up on the wall and
  then they can choose from like a million toppings and then
